...
export default function About() {
  return (
    <section id="about" className="py-24 px-6 max-w-5xl mx-auto">
      ...
      >
        <p className="text-[#6667AB] text-xs tracking-widest uppercase mb-2">Background</p>
        <h2 className="text-3xl font-bold text-[#2D2926] mb-10">About</h2>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <p className="text-[#2D2926]/70 text-sm leading-relaxed mb-4">
            ...
            multimodal deep learning for insect species classification &mdash; fusing
          ...
          <p className="text-[#2D2926]/70 text-sm leading-relaxed">
        ...
        >
          {skills.map(s => (
            <div key={s.category}>
              <p className="text-[#6667AB] text-xs tracking-widest uppercase mb-2">{s.category}</p>
